                ...
                IMU_ST_SENSOR_DATA *pstMagnRawData)
{
  ...
  pstMagnRawData->fX = (float)s16Magn[0]*MAG_SSF_AT_FS_4900uT;
  pstMagnRawData->fY = (float)s16Magn[1]*MAG_SSF_AT_FS_4900uT;
  pstMagnRawData->fZ = (float)s16Magn[2]*MAG_SSF_AT_FS_4900uT;  
