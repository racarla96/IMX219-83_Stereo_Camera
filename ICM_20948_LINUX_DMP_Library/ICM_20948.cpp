...
void ICM_20948::debugPrintStatus(ICM_20948_Status_e stat)
{
  ...
  case ICM_20948_Stat_SensorNotSupported:
    cout << "Sensor Not Supported";
    break;
  case ICM_20948_Stat_DMPNotSupported:
    cout << "DMP Firmware Not Supported. Is #define ICM_20948_USE_DMP commented in util/ICM_20948_C.h?";
    break;
  case ICM_20948_Stat_DMPVerifyFail:
    cout << "DMP Firmware Verification Failed";
    break;
  case ICM_20948_Stat_FIFONoDataAvail:
    cout << "No FIFO Data Available";
    break;
  case ICM_20948_Stat_FIFOIncompleteData:
    cout << "DMP data in FIFO was incomplete";
    break;
  case ICM_20948_Stat_FIFOMoreDataAvail:
    cout << "More FIFO Data Available";
    break;
  case ICM_20948_Stat_UnrecognisedDMPHeader:
    cout << "Unrecognised DMP Header";
    break;
  case ICM_20948_Stat_UnrecognisedDMPHeader2:
    cout << "Unrecognised DMP Header2";
    break;
  case ICM_20948_Stat_InvalDMPRegister:
    cout << "Invalid DMP Register";
    break;
  default:
    cout << "Unknown Status";
    break;
...
ICM_20948_Status_e ICM_20948::checkID(void)
{
  ...
  {
    cout << "ICM_20948::checkID: ICM_20948_check_id returned: ";
    cout << status;
    cout << endl;
  }
#endif
...
#ifdef DEBUG
  cout << "ICM_20948::isConnected: checkID returned: ";
  cout << status;
  cout << endl;
#endif
  return false;
...
uint8_t ICM_20948::i2cMasterSingleR(uint8_t addr, uint8_t reg)
{
  ...
  if (status != ICM_20948_Stat_Ok)
  {
    cout << "ICM_20948::i2cMasterSingleR: ICM_20948_i2c_master_single_r returned: ";
    cout << status;
    cout << endl;
  }
#endif
...
ICM_20948_Status_e ICM_20948::startupDefault(bool minimal)
{
  ...
  {
#ifdef DEBUG
    cout << "ICM_20948::startupDefault: checkID returned: ";
    cout << retval;
    cout << endl;
#endif
    status = retval;
  ...
  {
#ifdef DEBUG
    cout << "ICM_20948::startupDefault: swReset returned: ";
    cout << retval;
    cout << endl;
#endif
    status = retval;
  ...
  {
#ifdef DEBUG
    cout << "ICM_20948::startupDefault: sleep returned: ";
    cout << retval;
    cout << endl;
#endif
    status = retval;
  ...
  {
#ifdef DEBUG
    cout << "ICM_20948::startupDefault: lowPower returned: ";
    cout << retval;
    cout << endl;
#endif
    status = retval;
  ...
  {
#ifdef DEBUG
    cout << "ICM_20948::startupDefault: startupMagnetometer returned: ";
    cout << retval;
    cout << endl;
#endif
    status = retval;
  ...
  {
#ifdef DEBUG
    cout << "ICM_20948::startupDefault: minimal startup complete!" << endl;
#endif
    return status;
  }
  ...
  {
#ifdef DEBUG
    cout << "ICM_20948::startupDefault: setSampleMode returned: ";
    cout << retval;
    cout << endl;
#endif
    status = retval;
  ...
  {
#ifdef DEBUG
    cout << "ICM_20948::startupDefault: setFullScale returned: ";
    cout << retval;
    cout << endl;
#endif
    status = retval;
  ...
  {
#ifdef DEBUG
    cout << "ICM_20948::startupDefault: setDLPFcfg returned: ";
    cout << retval;
    cout << endl;
#endif
    status = retval;
  ...
  {
#ifdef DEBUG
    cout << "ICM_20948::startupDefault: enableDLPF (Acc) returned: ";
    cout << retval;
    cout << endl;
#endif
    status = retval;
  ...
  {
#ifdef DEBUG
    cout << "ICM_20948::startupDefault: enableDLPF (Gyr) returned: ";
    cout << retval;
    cout << endl;
#endif
    status = retval;
...
#ifdef DEBUG
    cout << "ICM_20948::enableDMPSensor:  _enabled_Android_0: ";
    cout << ((int)_device._enabled_Android_0);
    cout << "  _enabled_Android_1: ";
    cout << ((int)_device._enabled_Android_1);
    cout << "  _dataOutCtl1: ";
    cout << ((int)_device._dataOutCtl1);
    cout << "  _dataOutCtl2: ";
    cout << ((int)_device._dataOutCtl2);
    cout << "  _dataRdyStatus: ";
    cout << ((int)_device._dataRdyStatus);
    cout << endl;
#endif
    return status;
  }
...
#ifdef DEBUG
    cout << "ICM_20948::enableDMPSensorInt:  _enabled_Android_intr_0: ";
    cout << ((int)_device._enabled_Android_intr_0);
    cout << "  _enabled_Android_intr_1: ";
    cout << ((int)_device._enabled_Android_intr_1);
    cout << "  _dataIntrCtl: ";
    cout << ((int)_device._dataIntrCtl);
    cout << endl;
#endif
    return status;
  }
...
#ifdef DEBUG
    cout << "ICM_20948::setGyroSF:  pll: ";
    cout << ((int)_device._gyroSFpll);
    cout << "  Gyro SF is: ";
    cout << ((int)_device._gyroSF);
    cout << endl;
#endif
    return status;
  }
...
ICM_20948_Status_e ICM_20948::initializeDMP(void)
{
  ...
  {
#ifdef DEBUG
    cout << "ICM_20948::startupDMP: DMP is not available. Please check that you have uncommented line 29 (#define ICM_20948_USE_DMP) in ICM_20948_C.h...";
#endif
    return ICM_20948_Stat_DMPNotSupported;
  }
...
ICM_20948_Status_e ICM_20948_I2C::begin(int bus, bool ad0val)
{
  ...
  if (status != ICM_20948_Stat_Ok)
  {
    cout << "ICM_20948_I2C::begin: startupDefault returned: ";
    cout << status;
    cout << endl;
  }
#endif
...
ICM_20948_Status_e ICM_20948::startupMagnetometer(bool minimal)
{
  ...
  {
#ifdef DEBUG
    cout << "ICM_20948::startupMagnetometer: reached MAX_MAGNETOMETER_STARTS (";
    cout << ((int)MAX_MAGNETOMETER_STARTS);
    cout << "). Returning ICM_20948_Stat_WrongID" << endl;
#endif
  ...
  {
    cout << "ICM_20948::startupMagnetometer: successful magWhoIAm after ";
    cout << ((int)tries);
    if (tries == 1)
      cout << " try" << endl;
    else
  ...
  {
#ifdef DEBUG
    cout << "ICM_20948::startupMagnetometer: minimal startup complete!" << endl;
#endif
    return status;
  }
  ...
  {
#ifdef DEBUG
    cout << "ICM_20948::startupMagnetometer: writeMag returned: ";
    cout << retval;
    cout << endl;
#endif
    status = retval;
  ...
  {
#ifdef DEBUG
    cout << "ICM_20948::startupMagnetometer: i2cMasterConfigurePeripheral returned: ";
    cout << retval;
    cout << endl;
#endif
    status = retval;
...
ICM_20948_Status_e ICM_20948::magWhoIAm(void)
{
  ...
  {
#ifdef DEBUG
    cout << "ICM_20948::magWhoIAm: whoiam1: ";
    cout << ((int)whoiam1);
    cout << " (should be 72) readMag set status to: ";
    cout << status;
    cout << endl;
#endif
    return retval;
  ...
  if (retval != ICM_20948_Stat_Ok)
  {
    ...
    cout << "ICM_20948::magWhoIAm: whoiam1: ";
    cout << ((int)whoiam1);
    cout << " (should be 72) whoiam2: ";
    cout << ((int)whoiam2);
    cout << " (should be 9) readMag set status to: ";
    cout << status;
    cout << endl;
#endif
    return retval;
  ...
  cout << " (should be 72) whoiam2: ";
  cout << ((int)whoiam2);
  cout << " (should be 9). Returning ICM_20948_Stat_WrongID" << endl;
#endif
...
ICM_20948_Status_e ICM_20948_SPI::begin(uint8_t csPin, SPIClass &spiPort, uint32_t SPIFreq)
{
  ...
  if (status != ICM_20948_Stat_Ok)
  {
    cout << "ICM_20948_SPI::begin: startupDefault returned: ";
    cout << status;
    cout << endl;
  }
#endif
